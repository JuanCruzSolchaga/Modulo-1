...
A nivel personal, considero que las herramientas incorporadas en este primer módulo van a ser clave a lo largo de toda la carrera, no solo para la redacción de informes sino para encarar trabajos técnicos más complejos. En el ámbito profesional, donde la trazabilidad, la claridad y la organización de la información son fundamentales, estas habilidades tienen una aplicación directa y muy práctica.

Creo que el aprendizaje más importante que me llevo es entender la separación entre el contenido y el formato. A diferencia de lo que pasa con los procesadores de texto tradicionales, donde el formato te suele interferir constantemente, pasar a trabajar con lenguajes como LaTeX o HTML te obliga a pensar primero en la estructura lógica de lo que querés comunicar, y recién después enfocarte en la presentación visual.
